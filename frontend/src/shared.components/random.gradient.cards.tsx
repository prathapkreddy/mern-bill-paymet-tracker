export default function RandomGradientCards(props: any) {
    const { cardName, creditLimit, cardType, index, callBack } = props;
    ...
    return (
        <div onClick={callBack} key={index} className={`p-6 rounded-xl  shadow-lg ${bgClass}`} style={{ borderBottom: '15px solid #ccc' }}>
